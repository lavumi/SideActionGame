    ...
    var GameManager = function(_super) {
      ...
      GameManager.prototype.moveToCenter = function() {
        ...
        for (var i = 0; i < this._monsterDirectionArray.length; i++) {
          var targetPos = cc.v2((i + 1) * this._monsterDistance * this._monsterDirectionArray[i], 0);
      ...
      GameManager.prototype.makeNewMonster = function() {
        ...
        var moveTargetPos = cc.v2(index * this._monsterDistance * pos, 0);
        monster.setPosition(6 * this._monsterDistance * pos, 0);
  ...
  Monster: [ function(require, module, exports) {
    ...
    var Monster = function(_super) {
      ...
      Monster.prototype.init = function(isLeft, difficulty) {
        ...
        var healthContainer = cc.find("HealthContainer", this.node);
